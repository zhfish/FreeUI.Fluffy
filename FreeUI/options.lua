...
C["unitframes"] = {
	...
	["party"] = {"RIGHT", UIParent, "CENTER", -170, -220}, 	-- only applies with healer layout enabled
	["raid"] = {"TOPRIGHT", UIParent, "RIGHT", -20, -300}, 	-- only applies with healer layout enabled
