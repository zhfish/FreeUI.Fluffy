...
local chatfont = "Fonts\\cy_emblem.ttf"
local editboxfont = "Fonts\\cuyuan.ttf"
...
local function StyleWindow(f)
	...
	frame:SetFont(chatfont, 13, "OUTLINE")
	...
	frame.editBox:SetFont(chatfont, 13, "OUTLINE")
	frame.editBox.header:SetFont(chatfont, 13, "OUTLINE")
...
editBox:SetFont(chatfont, 13, "OUTLINE")
