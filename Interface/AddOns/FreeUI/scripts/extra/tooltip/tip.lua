...
--	font = mediapath.."expressway.ttf",
	...
	hideTitles = C.tooltip.hideTitles,
	hideRealm = C.tooltip.hideRealm,
	hideFaction = C.tooltip.hideFaction,
	hidePvP = C.tooltip.hidePvP,
	...
	bgcolor = { r=0.03, g=0.03, b=0.03, t=0.84 }, -- background
	...
	colorborderClass = C.tooltip.colorborderClass,
	colorborderItem = false,

	combathide = false,     -- world objects
	combathideALL = C.tooltip.combathideALL,  -- everything
...
GameTooltipHeaderText:SetFont(ttFont, cfg.fontsize+2, "OUTLINE")
GameTooltipText:SetFont(ttFont, cfg.fontsize, "OUTLINE")
GameTooltipTextSmall:SetFont(ttFont, cfg.fontsize-2, "OUTLINE")
