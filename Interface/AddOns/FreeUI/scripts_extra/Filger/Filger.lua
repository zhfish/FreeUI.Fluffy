...
local function SetTemplate(Parent, Size)
	...
	F:SetBackdropBorderColor(0, 0, 0, .6)
	return F
end
		...
		if not bar then
			...
			if self.Mode == "ICON" then
				...
				if bar.count then
					...
					bar.count:SetFont(Misc.font, Misc.numsize, "OUTLINEMONOCHROME")
				...
				if bar.statusbar then
					...
					if self.IconSide == "LEFT" then
						bar.statusbar:SetPoint("BOTTOMLEFT", bar, "BOTTOMRIGHT", 3, 3)
					elseif self.IconSide == "RIGHT" then
						bar.statusbar:SetPoint("BOTTOMRIGHT", bar, "BOTTOMLEFT", -3, 3)
					end
				end
				...
				if bar.time then
					...
					bar.time:SetFont(Misc.font, Misc.numsize, "OUTLINEMONOCHROME")
				...
				if bar.spellname then
					...
					bar.spellname:SetFont(Misc.font, Misc.namesize, "OUTLINEMONOCHROME")
