...
ns.localization.generalauratrackerTooltip = "Track some important auras, based on classic Filger."
ns.localization.generalauratracker_test = "Test mod"
ns.localization.generalauratracker_testTooltip = "Enable test mod to adjust icon position."
ns.localization.generalbiggertradeskillui = "Bigger Trade skill UI"
ns.localization.generalbiggertradeskilluiTooltip = "Make trade skill UI bigger, gives more space to have easier access to the filters and a have a longer list."
...
ns.localization.generalscreenshot = "Achievement Screenshotter"
ns.localization.generalscreenshotTooltip = "Take screenshots of Achievements."
ns.localization.generalobjectivetracker = "Objectivetracker"
ns.localization.generalobjectivetrackerTooltip = "Restyle the default objectivetracker. You may want to disable this option if you prefer another objectivetracker addon."
...
ns.localization.generalshowtreasures = "Show treasures"
ns.localization.generalshowtreasuresTooltip = "toggle the treasures marked from the various treasure maps sold in Ashran."
...
ns.localization.generalemergencyTooltip = "Play a sound when your health or mana reaches a critical level (less than 30%)."
...
ns.localization.unitframesspellRange = "Spell range support"
ns.localization.unitframesspellRangeTooltip = ""
...
ns.localization.unitframeslimitRaidSizePVE = "Limit raid size PVE"
ns.localization.unitframeslimitRaidSizePVETooltip = "Check to show a maximum of 30 players in a raid group."
ns.localization.unitframeslimitRaidSizePVP = "Limit raid size PVP"
ns.localization.unitframeslimitRaidSizePVPTooltip = "Check to show a maximum of 15 players in a raid group."
...
ns.localization.tooltiptitle = "Hide player titles"
ns.localization.tooltiprealm = "Hide player realm"
ns.localization.tooltiprank = "Hide player guild rank"
ns.localization.tooltippvp = "Hide PVP status"
ns.localization.tooltipfaction = "Hide faction"
ns.localization.tooltiphide = "Hide world objects while in combat"
ns.localization.tooltiphideall = "Hide everything while in combat"
ns.localization.tooltipid = "Show aura id"
ns.localization.tooltipcaster = "Show (if possible) who applied the aura"
ns.localization.tooltipilvl = "Show item level"
ns.localization.tooltipspec = "Show specialization"
