...
ns.localization.generalobjectivetracker = "任务追踪"
ns.localization.generalobjectivetrackerTooltip = "美化默认的任务追踪外观。禁用这个选项如果你想使用另外的任务追踪插件。"
...
ns.localization.unitframescastbarTooltip = "启用自带施法条，如果想使用其他施法条插件则禁用此项"
...
ns.localization.tooltipSubText = "美化调整鼠标信息的外观和功能。"
...
ns.localization.tooltiptitle = "头衔"
ns.localization.tooltippvp = "PVP状态"
